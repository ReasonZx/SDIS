...
public class test {
	...
	public static void main(String args[]) throws InterruptedException, FileNotFoundException, UnsupportedEncodingException {
		...
		PrintWriter writer1 = new PrintWriter("results_axis.txt", "UTF-8");;
		int bitrate = 100;
			    ...
			    for(int i=0 ; i < nodeCount ; i++) {
				    if(str_array.get(i).contains("work") && !over_list[i]) {
				    	...
				    	/*if((double) num_over / nodeCount > 0.95 && !do_once[10]) {
				    		...
				    		writer.println((System.currentTimeMillis() - startTime)+ " ");
				    		writer1.println("0.92");
				    		do_once[9] = true;
				    	}*/
				    	if((double) num_over / nodeCount > 0.9 && !do_once[8]) {
				    		System.out.printf(format,"0.9 converged in", System.currentTimeMillis() - startTime , " ms");
				    		writer.print((System.currentTimeMillis() - startTime) + " ");
				    		writer1.print("0.9");
				    		do_once[8] = true;
				    	}
